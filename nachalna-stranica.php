...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="neubar">
      <div class="container">
        <div style="display: flex;">
          ...
          <a class="logo" class="navbar-brand" href="/nachalna-stranica">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul id="menusTop" class="navbar-nav ms-auto ">
            ...
            <li class="nav-item">
              <a class="nav-link mx-2 btnStyle" href="/menu/rezultati">РЕЗУЛТАТИ</a>
            </li>
  ...
  <main>
    ...
    <div id="first" class="boxOne">
      ...
      <a class="anchorStyle" href="./polzi-ot-pluvaneto">
        <div class="firstIMG">
          <p class="imgP">Ползи от плуването</p>
        </div>
      </a>

      <a class="anchorStyle" href="./aktualen-grafik">
        <div class="secondIMG">
    ...
    <div id="second" class="boxTwo">
      ...
      <a class="anchorStyle" href="./Dashboard/sporten-kalendar">
        <div class="thirdIMG">
          <p class="thirdP">Календар</p>
        </div>
      </a>

      <a class="anchorStyle" href="/istoriya-na-kluba">
        <div class="fourthIMG">
    ...
    <div id="third" class="boxThree">
      ...
      <a class="anchorStyle" href="./galeriya">
        <div class="fifthIMG">
          <p class="thirdP">Галерия</p>
        </div>
      </a>

      <a class="anchorStyle" href="/medalisti">
        <div class="sixthIMG">
