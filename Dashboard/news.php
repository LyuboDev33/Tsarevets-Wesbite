  ...
  <body>
        ...
        <div class="report-container">
          ...
          <form id="templateForm" class='formStyles' enctype="multipart/form-data" method="POST">
            ...
            <div class="divVision">
              ...
              <label class="labelNews">Линк: </label>
          ...
          while ($rowGet = mysqli_fetch_assoc($queryGet)) {
            ...
            echo "<label class=\"labelNews\" for=\"link\"> </label>";
            echo "<input value=\"" . $rowGet['link'] . "\" placeholder=\"Пр: име-на-статия.php\" type=\"hidden\" name=\"linkSet\" id=\"link\"><u>";
            echo "<br>";

            echo "<button id=\"saveChanges\" class=\"btnSubmitArticle\" type=\"submit\">Запази промените</button>";

            echo "<button class='btnSubmitArticle showModalArticle delArticle' type='submit'>Изтрии статия</button>";
    ...
    <script>
      $(document).ready(function() {
        ...
        let delBtn = $('.delArticle');
        let formArticle = $('.formStyles');
        ...
        $('.delArticle').on('click', function(e) {
          ...
          let linkData = formData.find('#link').val();
