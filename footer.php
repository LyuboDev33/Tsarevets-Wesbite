      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-12 links">
          <ul class="m-0 p-0">
            ...
            <li style="list-style: none;"> <a href="./privacy settings/privacy.php">Политика за поверителност</a></li>
            <li style="list-style: none;"><a href="./privacy settings/privacy.php" >Общи условия</a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-xs-12 location">
          <p class="text-white-50">Велико търново, България<img class="bulgarian-flag" src="../images/Flag_of_Bulgaria.svg.png" alt=""></p>
