...
<p class="donation-text"><i class="fa-regular fa-handshake"></i> Клуб Царевец приветства всички предложения за дарения и спонсорство. <i class="fa-regular fa-handshake"></i></p>
<p class="donation-text">Можете да се свържете с нас на телефон: <br>
            <ul class="list-phones">
              <li><i class="fas fa-mobile-alt"></i> Даниел Стоянов - 0878 687 555</li>
              <li><i class="fas fa-mobile-alt"></i> Панайот Паздерков - 0898 579 010</li>
            </ul>
            </p>
...
<div class="col-md-10 col-lg-6 col-lg-4">
  <a href="https://www.facebook.com/hemussport/">
<div class="square-holder">
<img id="hemus" alt="hemus-sport" src="/images/хемус.png" />
</div>
</a>
</div>
